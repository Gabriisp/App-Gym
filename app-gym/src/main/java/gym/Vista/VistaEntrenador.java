...
public class VistaEntrenador {
    ...
    public int mostrarMenuEntrenador(String nombre) {
        ...
        // OPCIONES ACTUALIZADAS - con nueva opción de gestionar solicitudes
        String[] opciones = {
                "Ver mis usuarios asignados",
                "Ver rutinas de clientes",
                "Crear rutina para cliente",
                "Ver/Editar ejercicios de rutina",
                "Eliminar rutina",
                "Ver progreso clientes",
                "Gestionar Solicitudes", // NUEVA OPCIÓN
                "Cerrar sesión"
        };
    ...
    // NUEVO MÉTODO: Mostrar selección de solicitudes
    ...
    public int mostrarOpcionesSolicitud(Entidades.Asignacion solicitud) {
        ...
        info.append("Mensaje: ").append(solicitud.getMensajeSolicitud() != null ? solicitud.getMensajeSolicitud() : "Sin mensaje");
    ...
    public void mostrarRutinas(List<Entidades.Rutina> rutinas) {
        ...
        StringBuilder sb = new StringBuilder("Todas las rutinas:\n\n");
        for (Entidades.Rutina r : rutinas) {
            try {
                ...
                sb.append("• ").append(r.getNombre())
                        ...
                        .append(" (Creada por: ").append(nombreUsuario).append(")")
        ...
        JOptionPane.showMessageDialog(null, scroll, "Todas las Rutinas", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    public void mostrarProgresoCompletoCliente(List<Entidades.Entrenamiento> entrenamientos,
        ...
        // Pestaña 1: Historial de Entrenamientos
        ...
        // Pestaña 2: Progreso por Ejercicio
        ...
        // Llenar combobox con ejercicios
            ...
            if (comboEjercicios.getSelectedIndex() >= 0) {
                try {
                    ...
                    if (progreso.isEmpty()) {
                        ...
                        // Calcular mejora si hay más de una sesión
                        if (progreso.size() > 1) {
                            Entidades.ProgresoEjercicio primera = progreso.get(progreso.size() - 1); // Más antigua
                            Entidades.ProgresoEjercicio ultima = progreso.get(0); // Más reciente
