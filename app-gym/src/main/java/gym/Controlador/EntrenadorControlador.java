...
public class EntrenadorControlador {
    ...
    // Ver las rutinas asignadas a los clientes del entrenador
    private void verRutinasClientes() {
        try {
            List<Entidades.Rutina> rutinas = GestorBD.obtenerRutinasDeMisClientes(entrenador.getIdUsuario());
            vistaEntrenador.mostrarRutinas(rutinas);
        } catch (SQLException e) {
            vistaEntrenador.mostrarError("Error al cargar rutinas: " + e.getMessage());
        }
    }
