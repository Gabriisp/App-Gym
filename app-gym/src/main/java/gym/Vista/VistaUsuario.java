...
public class VistaUsuario {
    ...
    public int mostrarMenuUsuario(String nombre) {
        ...
        String[] opciones = {
            ...
            "Ver mi progreso",
            "Eliminar Rutina",
            "Solicitar Entrenador", // NUEVA OPCIÓN
            "Cerrar sesión"
        };
    ...
    // NUEVO MÉTODO: Mostrar selección de entrenador
    ...
    // NUEVO MÉTODO: Mostrar mensaje de solicitud
    ...
    public void mostrarProgresoCompleto(List<Entidades.Entrenamiento> entrenamientos, 
        ...
        // Botón para ver detalles de entrenamiento específico
